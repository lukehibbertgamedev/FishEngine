...
namespace Fish {
	namespace Timer {
		...
		Fish::Timer::EngineTimer::EngineTimer()
		...
		float Fish::Timer::EngineTimer::engine_time() const
		{
		...
		float Fish::Timer::EngineTimer::delta_time() const
		{
		...
		void Fish::Timer::EngineTimer::start()
		{
			__int64 startTime;
		...
		void Fish::Timer::EngineTimer::stop()
		{
		...
		void Fish::Timer::EngineTimer::tick()
		{
			if (mStopped)
			{
				mDeltaTime = 0.0;
